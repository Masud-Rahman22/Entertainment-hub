...
const UpdateProduct = () => {
    ...
    return (
        <div>
            <form onSubmit={handleToUpdate} className="md:w-4/5 mx-auto my-10">
                ...
                <button type="submit" className="text-white bg-orange-400 focus:ring-4 focus:outline-none hover:bg-black font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Update</button>
            </form>
        </div>
    );
};
